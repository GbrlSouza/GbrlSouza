...
[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=00bfbf&size=35&center=true&vCenter=true&width=1000&lines=Olá!+...+Meu+nome+é+Gabriel;Sou+Dev+front-end+e+QA;Resido+em+Campinas,+São+Paulo,+Brasil;Sejam+Bem-vindos!+:%29)](https://git.io/typing-svg)
...
<details>
  ...
  - 💬 Me chama pra conversar sobre: <strong>QA</strong>, <strong>automação</strong>, <strong>componentização</strong>, <strong>React Native</strong>, ou qualquer projeto doido e inovador.<br />
